defmodule Libu.Identity.User do
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Libu.Repo)
  ...
  `Argon2.no_user_verify/0` a blank password to avoid timing attacks.
  """
  def valid_password?(%Libu.Identity.User{hashed_password: hashed_password}, password)
